...
int main() {
  ...
  //     Eigen::Matrix<double,6,1>::Zero(); Eigen::Matrix<double,6,1>
  //     imu_measurement_prev = Eigen::Matrix<double,6,1>::Zero(); double t = 0;
  //     double t_prev = 0;
  ...
  //             cout << "Received CONTACT Data, setting filter's contact
  ...
  //                 (stod98(measurement[i+1]),stod98(measurement[i+2]),stod98(measurement[i+3]),stod98(measurement[i+4]));
  //                 q.normalize();
  //                 p <<
  //                 stod98(measurement[i+5]),stod98(measurement[i+6]),stod98(measurement[i+7]);
